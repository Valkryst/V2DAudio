...
public abstract class AudioSettings {
     ...
     * the left channel.
     *
     * @see javafx.scene.media.AudioClip#balance
     * @see javafx.scene.media.MediaPlayer#balance
     */
     ...
     *
     * @see javafx.scene.media.AudioClip#cycleCount
     * @see javafx.scene.media.MediaPlayer#cycleCount
     */
     ...
     *
     * @see javafx.scene.media.AudioClip#rate
     * @see javafx.scene.media.MediaPlayer#rate
     */
     ...
     *
     * @see javafx.scene.media.AudioClip#volume
     * @see javafx.scene.media.MediaPlayer#volume
     */
